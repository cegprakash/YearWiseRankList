...
public class GetRefreshToken {
  ...
  /**
   * The OAuth2 scope for the blogger API.
   */
  public static final String DFP_BLOGGER_SCOPE = "https://www.googleapis.com/auth/blogger";

  /**
   * Scopes to include in the authorization request. Add to this list any additional scopes you want
   * to include.
   */
  private static final List<String> SCOPES = Lists.newArrayList(DFP_BLOGGER_SCOPE);

  // This callback URL will allow you to copy the token from the success screen.
  private static final String CALLBACK_URL = "http://cegcodingcamp.blogspot.com";
